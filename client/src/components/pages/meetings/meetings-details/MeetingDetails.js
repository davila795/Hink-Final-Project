...
import Comments from '../meetings-comments/Comments'
                    ...
                    {this.state.meeting
                        ...
                        <>
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    <h3>{this.state.meeting.tittle}<small className="text-muted">{' | ' + this.state.meeting.type}</small></h3>
                                    ...
                                    <hr />
                                    <p>{this.state.meeting.location + ', ' + this.state.meeting.city}</p>
                            ...
                            <Row>
                                <Col md={{ span: 8, offset: 2 }}>
                                    <Comments comments={this.state.meeting.comments} />
                                </Col>
                            </Row>
                        </>
                        :
